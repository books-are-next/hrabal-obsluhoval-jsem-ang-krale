...
async function cache(context) {
    return caches
        ...
        return cache.addAll(["./","./colophon.html","./index.html","./manifest.json","./obsluhoval_jsem_anglickeho_krale_005.html","./obsluhoval_jsem_anglickeho_krale_006.html","./obsluhoval_jsem_anglickeho_krale_007.html","./obsluhoval_jsem_anglickeho_krale_008.html","./obsluhoval_jsem_anglickeho_krale_009.html","./obsluhoval_jsem_anglickeho_krale_011.html","./promo.html","./assets/android-chrome-144x144.png","./assets/android-chrome-192x192.png","./assets/android-chrome-256x256.png","./assets/android-chrome-36x36.png","./assets/android-chrome-384x384.png","./assets/android-chrome-48x48.png","./assets/android-chrome-512x512.png","./assets/android-chrome-72x72.png","./assets/android-chrome-96x96.png","./assets/apple-touch-icon-1024x1024.png","./assets/apple-touch-icon-114x114.png","./assets/apple-touch-icon-120x120.png","./assets/apple-touch-icon-144x144.png","./assets/apple-touch-icon-152x152.png","./assets/apple-touch-icon-167x167.png","./assets/apple-touch-icon-180x180.png","./assets/apple-touch-icon-57x57.png","./assets/apple-touch-icon-60x60.png","./assets/apple-touch-icon-72x72.png","./assets/apple-touch-icon-76x76.png","./assets/apple-touch-icon-precomposed.png","./assets/apple-touch-icon.png","./assets/cover-1200x1200.png","./assets/cover-1200x620.png","./assets/cover-1600x2560.png","./assets/cover-398x566.png","./assets/favicon-16x16.png","./assets/favicon-32x32.png","./assets/favicon-48x48.png","./assets/favicon.ico","./assets/icon.png","./assets/manifest.webmanifest","./fonts/Literata-Italic-var.woff2","./fonts/Literata-var.woff2","./fonts/LiterataTT-TextItalic.woff2","./fonts/LiterataTT-TextRegular.woff2","./fonts/LiterataTT-TextSemibold.woff2","./fonts/LiterataTT_LICENSE.txt","./fonts/SpaceGroteskVF.woff2","./fonts/SpaceGroteskVF_LICENSE.txt","./resources/image001_fmt.png","./resources/image002_fmt.png","./resources/kocka_fmt.png","./resources/obalka_obsluhoval_jsem__fmt.png","./resources/upoutavka_eknihy_fmt.png","./scripts/bundle.js","./style/style.min.css","./template-images/circles.png"]);
    })
